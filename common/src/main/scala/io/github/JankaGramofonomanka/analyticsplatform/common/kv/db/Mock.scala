...
class Mock[F[_]: Monad] extends ProfilesDB[F] with AggregatesDB[F] {


  private val profiles:   Map[Cookie,         SimpleProfile]  = Map()
  private val aggregates: Map[AggregateInfo,  AggregateValue] = Map()
